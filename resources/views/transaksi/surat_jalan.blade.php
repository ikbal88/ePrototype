            ...
            <div class="widget-body">
              <form id="formAdd" name="formAdd" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                ...
                <fieldset>
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label">Dikirim Oleh </label>
                    <div class="col-md-2">
...
@include('transaksi.view.modalGeneralView_surat_jalan');
@endsection
...
function viewData(id) {
  $.ajax({
    ...
    success: function(data) {
      ...
      var s = '';
      var catatan = (t == 'p') ? 'Surat Jalan' : 'Surat Jalan';
...
function printData(id) {
  window.open(baseurl+'/surat_jalan/'+id+'/print');
