              ...
              <form id="formAdd" name="formAdd" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                ...
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <select class="select2" style="width:100%;" name="id_costumer" required></select>
                    </div>
...
function printData(id) {
  window.open(baseurl+'/trans/'+id+'/print');
}
