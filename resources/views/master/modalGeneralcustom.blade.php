    ...
    <div class="modal-content">
      <form id="formEdit" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="name_edit" class="col-md-3 control-label">Alamat {{ $title }}</label>
            <div class="col-md-6">
              <input type="text" id="alamat_edit" name="alamat_edit" class="form-control" autofocus required>
              <span class="help-block with-errors"></span>
            </div>
          </div>

          <div class="form-group">
            <label for="name_edit" class="col-md-3 control-label">No Telepon {{ $title }}</label>
            <div class="col-md-6">
              <input type="text" id="no_telepon_edit" name="no_telepon_edit" class="form-control" autofocus required>
              <span class="help-block with-errors"></span>
            </div>
          </div>
